        ...
        {experiences.map((experience, index) => (
          <div
            ...
            className={`relative w-full flex ${
              index % 2 === 0
                ? 'justify-start text-left pr-6'
                : 'justify-end text-left pl-6'
            } mb-8 items`}
          >
            ...
            <div className='w-1/2 md:px-4'>
              ...
              <h3 className='mt-1 text-xs md:text-sm font-semibold text-gray-500'>
                {experience.role}
              </h3>
              <h3 className='mt-1 text-xs md:text-sm font-semibold text-gray-400'>
